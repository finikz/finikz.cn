...
export default function Home() {
  ...
  return <main className="studio-home" id="top">
    <SiteNav home />
    <section className="studio-hero"><div><p className="kicker">AI, STRATEGY & CULTURE — 2026</p><h1>让判断<em>产生复利</em></h1><p className="studio-intro">Finikz 张凤鸣<br />AI 与营销战略顾问 ｜ 跨文化内容创作者</p></div><aside className="hero-meta">企业 AI 战略咨询 / 营销战略咨询<br />跨文化内容创作 / 中英法三语翻译<br />中山大学广州校友会常务副秘书长<br />九维精酿-九维艺术联盟联合创办人</aside><i className="hero-rule" /></section>

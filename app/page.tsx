...
export default function Home() {
  ...
  return <main className="studio-home" id="top">
    <SiteNav home />
    <section className="studio-hero"><div><h1>Finikz</h1><div className="studio-intro"><strong>AI 与营销战略顾问 ｜ 跨文化内容创作者</strong><p>中山大学法语系毕业，以中英法三种语言工作，擅长用 AI 把文化洞察、商业策略与内容表达，整合成一套长期复利的系统。</p><aside className="hero-meta">企业 AI 战略咨询 / 营销战略咨询<br />跨文化内容创作 / 中英法三语翻译<br />中山大学广州校友会常务副秘书长<br />九维精酿-九维艺术联盟联合创办人</aside></div></div><i className="hero-rule" /></section>
    ...
    <section className="studio-bottom" id="notes"><div className="studio-label">LATEST NOTES<strong>最近文章</strong></div>{latest && <a className="latest-note" href={`/articles/${latest.slug}`}><span>ESSAY / {latest.date.slice(5).replace("-", ".")}</span><h2>{latest.title}</h2><b>↗</b></a>}</section>

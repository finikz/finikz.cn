...
export default function Home() {
  ...
  return <main className="studio-home" id="top">
    <nav className="nav" aria-label="主导航"><a className="brand" href="#top">FINIK<span className="brand-dot">Z</span><small>张凤鸣 / PERSONAL STUDIO</small></a><div className="nav-links"><a href="/about">About</a><a href="/works">Works</a><a href="/articles">Notes</a></div></nav>

...
const practices = [
  ...
  { no: "03 / TRANSLATION", name: "文章与译作", description: "关于人工智能、内容、商业与文化；也保存经得起回看的问题与跨文化的作品。", href: "/works" },
];

export default function Home() {
  const latest = articles[0];
  return <main className="studio-home" id="top">
    <nav className="nav" aria-label="主导航"><a className="brand" href="#top">FINIK<span className="brand-dot">Z</span><small>张凤鸣 / PERSONAL STUDIO</small></a><div className="nav-links"><a href="#top">首页</a><a href="/works">作品</a><a href="#about">经历</a><a href="/articles">文章</a><a href="mailto:hello@finikz.cn">联系</a></div></nav>
